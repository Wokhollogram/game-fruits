class Game {
    ...
    randomFruitGenerate() {
        let runFruit = random(0, 2);
        this.generate(this.fruits[runFruit]);
    }
    ...
    timer() {
        ...
        this.ended = true;
        let time = this.time;
        if (time.s1 >= 3 || time.m2 >= 1 || time.m1 >= 1) {
        ...
        go('end', 'panel d-flex justify-content-center alight-items-center');
    }
